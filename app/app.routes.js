...
var APP_ROUTES = [
    ...
    { path: 'admin/hirek', component: hirekLista_component_1.HirekListaComponent },
    { path: 'admin/hirek/modify/:id', component: hirekModify_1.HirekModifyComponent },
    { path: 'admin/eredmenyek/new', component: eredmenyekModify_1.EredmenyekModifyComponent },
    { path: 'admin/eredmenyek', component: eredmenyekLista_component_1.EredmenyekListaComponent },
    { path: 'admin/eredmenyek/modify/:id', component: eredmenyekModify_1.EredmenyekModifyComponent },
    { path: 'admin/hirek/new', component: hirekModify_1.HirekModifyComponent },
    { path: 'admin/vasarlasok', component: vasarlasok_component_1.VasarlasListaComponent },
    { path: 'eredmeny-hirdetes', component: eredmeny_component_1.EredmenyComponent },
    { path: 'hireink', component: hireink_component_1.HireinkComponent },
