...
var DateTimePickerComponent = (function () {
    function DateTimePickerComponent(elem) {
        var _this = this;
        this.elem = elem;
    ...
    DateTimePickerComponent.prototype.removeBtnClicked = function () {
        this.selectionDayTxt = '';
        this.selectedDate = { year: 0, month: 0, day: 0 };
        this.dateChanged.emit({ date: {}, formatted: this.selectionDayTxt, epoc: 0 });
    };
    DateTimePickerComponent.prototype.openBtnClicked = function () {
    ...
    DateTimePickerComponent.prototype.todayClicked = function () {
        // Today selected
    ...
    DateTimePickerComponent.prototype.cellClicked = function (cell) {
    ...
    DateTimePickerComponent.prototype.preZero = function (val) {
        // Prepend zero if smaller than 10
        return parseInt(val) < 10 ? '0' + val : val;
    };
    DateTimePickerComponent.prototype.formatDate = function (val) {
        return this.dateFormat.replace('yyyy', val.year)
            .replace('mm', this.preZero(val.month))
            .replace('dd', this.preZero(val.day));
    };
    DateTimePickerComponent.prototype.monthText = function (m) {
        // Returns mont as a text
        return this.monthLabels[m];
    };
    DateTimePickerComponent.prototype.monthStartIdx = function (y, m) {
        // Month start index
        var d = new Date();
        d.setDate(1);
        d.setMonth(m - 1);
    ...
    DateTimePickerComponent.prototype.daysInMonth = function (m, y) {
        // Return number of days of current month
        return new Date(y, m, 0).getDate();
    };
    DateTimePickerComponent.prototype.daysInPrevMonth = function (m, y) {
    ...
    DateTimePickerComponent.prototype.isCurrDay = function (d, m, y, cmo) {
        // Check is a given date the current date
        return d === this.today.getDate() && m === this.today.getMonth() + 1 && y === this.today.getFullYear() && cmo === 2;
    };
    DateTimePickerComponent.prototype.isDisabledDay = function (date) {
    ...
    DateTimePickerComponent.prototype.getTimeInMilliseconds = function (date) {
        return new Date(date.year, date.month, date.day, 0, 0, 0, 0).getTime();
    };
    DateTimePickerComponent.prototype.getDayNumber = function (date) {
        // Get day number: sun=0, mon=1, tue=2, wed=3 ...
        var d = new Date(date.year, date.month - 1, date.day, 0, 0, 0, 0);
        return d.getDay();
    };
    DateTimePickerComponent.prototype.sundayIdx = function () {
        // Index of Sunday day
        return this.dayIdx > 0 ? 7 - this.dayIdx : 0;
    };
    DateTimePickerComponent.prototype.createMonth = function (m, y) {
        this.dates.length = 0;
    ...
    DateTimePickerComponent.prototype._parseDate = function (ds) {
    ...
    ], DateTimePickerComponent.prototype, "options", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], DateTimePickerComponent.prototype, "locale", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], DateTimePickerComponent.prototype, "defaultMonth", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], DateTimePickerComponent.prototype, "selDate", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', core_1.EventEmitter)
    ], DateTimePickerComponent.prototype, "dateChanged", void 0);
